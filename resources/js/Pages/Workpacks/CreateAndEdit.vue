<template>
    ...
    <AuthenticatedLayout :can="can">
        ...
        <template v-slot:header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Edit Work Pack</h2>
        </template>
            ...
            <div class="p-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form class="jw-form" @submit.prevent="submit">
                    ...
                    <div class="pb-4">
                        ...
                        <select id="active" v-model="form.active" name="show">
                    ...
                    <div class="sm:flex sm:items-center">
                        ...
                        <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none space-x-6">
                            ...
                            <button class="jw-btn jw-btn__blue" type="submit">Update Work Pack</button>
                        </div>
                    </div>
...
export default {
    ...
    setup(props) {
        ...
        function submit() {
            Inertia.post(route('workpacks.update', form.id), form);
        }
