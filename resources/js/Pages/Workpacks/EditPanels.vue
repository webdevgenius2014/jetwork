    ...
    <AuthenticatedLayout :can="can">
        ...
        <template v-slot:default>
            ...
            <div class="workpack-schematic-header my-6">
                <h1 class="font-semibold text-2xl text-gray-800 mb-4">{{ workpack.name }}</h1>
                <AirframeAeroplaneDetails :airframe="airframe" :workpack="workpack"/>
            </div>

            <div class="p-6 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form class="jw-form" @submit.prevent>
                    ...
                    <div class="sm:flex sm:items-center">
                        ...
                        <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none space-x-6">
                            ...
                            <button @click.prevent="submit" class="jw-btn jw-btn__blue" type="button">Update Work Pack</button>
                        </div>
                    </div>
    ...
    setup(props) {
        ...
        const submit = function (event) {
            ...
            if( props.schematic !== null ){
                routeData.schematic = props.schematic.id
            }
            Inertia.post(route('workpacks.update.panels', routeData), form);
        }
