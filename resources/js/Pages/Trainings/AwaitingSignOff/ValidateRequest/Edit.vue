...
export default {
    ...
    methods: {
        redirectToValidation(taskRequestId) {
            this.$inertia.visit(route('taskrequests.reviewDocument', {
                'taskRequestId': taskRequestId
            }));
        },
        redirectToAssesment(taskRequestId) {
            this.$inertia.visit(route('taskrequests.assesment', {
                'taskRequestId': taskRequestId
            }));
        }
